const About = () => {
  ...
  <div className="max-w-5xl mx-auto p-4 sm:p-6 bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 min-h-screen">
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 sm:p-10 border dark:border-gray-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-4 border rounded dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
          <h3 className="font-bold mb-2 text-gray-800 dark:text-white">✈️ Flight Booking</h3>
        ...
        <div className="p-4 border rounded dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
          <h3 className="font-bold mb-2 text-gray-800 dark:text-white">📄 Smart Bookings</h3>
          <p className="text-gray-600 dark:text-gray-300 text-sm">
        ...
        <div className="p-4 border rounded dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
          <h3 className="font-bold mb-2 text-gray-800 dark:text-white">📊 Admin Dashboard</h3>
          <p className="text-gray-600 dark:text-gray-300 text-sm">
        ...
        <div className="p-4 border rounded dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
          <h3 className="font-bold mb-2 text-gray-800 dark:text-white">⚡ Real-Time System</h3>
          <p className="text-gray-600 dark:text-gray-300 text-sm">
